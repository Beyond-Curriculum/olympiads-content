...
[Problem Solving Strategies by Arthur Engel](https://cdn.bc-pf.org/resources/math/combinatorics/Arthur_Engel-Problem_Solving_Strategies.pdf) — это хорошая книга для начала. По большей части она содержит задачи легко-средней сложности.
...
4. Chapter 5: Enumerative Combinatorics
   ...
   **Примечание:** если у вас есть проблемы с пониманием E13 a.k.a Cayley’s Formula, то вы можете прочитать более внятное решение отсюда: [Graph Theory and Cayley’s Formula by Chad Casaratto](https://cdn.bc-pf.org/resources/math/combinatorics/graphs/Casarotto-graph_theory_and_Cayleys_formula.pdf).
...
[Combinatorial Problems in Mathematical Competitions by Yao Zhang](https://cdn.bc-pf.org/resources/math/combinatorics/Yao_Zhang-combinatorial_problems_in_mathematical_competitions.pdf) содержит более тяжёлые задачи. Из-за разности в уровни советуем пройти даже те темы, которые были в Problem Solving Strategies.
...
1. Chapter 7: Counting in Two Ways — [Combinatorial Problems in Mathematical Competitions by Yao Zhang](https://cdn.bc-pf.org/resources/math/combinatorics/Yao_Zhang-combinatorial_problems_in_mathematical_competitions.pdf)

2. [Counting in Two Ways (MOP 2007 Black Group) by Yufei Zhao](https://cdn.bc-pf.org/resources/math/combinatorics/Yufei_Zhao-Double_Counting.pdf) (ненужные части были вырезаны)
...
## Теория графов
Очень много задач можно свести к графам, даже если на первый взгляд этот раздел не имеет ничего общего с задачей. Идеи теории графов можно применять в любых задачи, в которых можно определить ребра и вершины. Также советуем посмотреть две статьи из [Problems from the Book by Titu Andreescu](https://cdn.bc-pf.org/resources/math/others/Andreescu_Dospinescu-Problems_from_the_Book.pdf), которые мы привели.
1. [Hall's Marriage Theorem by Carl Joshua Quines](https://cdn.bc-pf.org/resources/math/combinatorics/graphs/Carl_Joshua_Quines-Halls_marriage_theorem.pdf)
2. [Подборка красивых задач на графы](https://cdn.bc-pf.org/resources/math/combinatorics/graphs/Aibek_Arslan-Graphs_problem_set.pdf)
3. Chapter 6: Some Classical Problems in Extremal Graph Theory — [Problems from the Book by Titu Andreescu](https://cdn.bc-pf.org/resources/math/others/Andreescu_Dospinescu-Problems_from_the_Book.pdf)
4. Chapter 22: Cycles, Paths, and Other Ways — [Problems from the Book by Titu Andreescu](https://cdn.bc-pf.org/resources/math/others/Andreescu_Dospinescu-Problems_from_the_Book.pdf)
...
2. Lecture 11: Generating Functions — [Awesome Math 2007 by Yufei Zhao](https://cdn.bc-pf.org/resources/math/combinatorics/generating_functions/Yufei_Zhao-Generating_functions_lectures_11-14.pdf)

3. [Snake oil method: Evaluation of sums](https://cdn.bc-pf.org/resources/math/combinatorics/generating_functions/Snake_Oil_Method_evaluation_of_sums.pdf)

4. Chapter 7: Complex Combinatorics — [Problems from the Book by Titu Andreescu](https://cdn.bc-pf.org/resources/math/others/Andreescu_Dospinescu-Problems_from_the_Book.pdf)

5. Chapter 8: Formal Series Revisited — [Problems from the Book by Titu Andreescu](https://cdn.bc-pf.org/resources/math/others/Andreescu_Dospinescu-Problems_from_the_Book.pdf)

   **Примечание:** главы 7 и 8 опциональны, но красивы.

6. [Generatingfunctionology by Herbert S. Wilf](https://cdn.bc-pf.org/resources/math/combinatorics/generating_functions/Herbert_Wilf-Generatingfunctionology.pdf) и [Topics in Generating Functions by Qiaochu Yuan](https://cdn.bc-pf.org/resources/math/combinatorics/generating_functions/Qiaochu_Yuan-Topics_in_generating_functions.pdf)
...
1. [Olympiad Combinatorics by Pranav Sriram](https://cdn.bc-pf.org/resources/math/combinatorics/Pranav_Sriram-Olympiad_Combinatorics.pdf)


Форум по обсуждению задач из Olympiad Combinatorics by Pranav Sriram — [AoPS](https://artofproblemsolving.com/community/c575226_olympiad_combinatorics_pranav_sriram). 

Объявление о возможности скачать эту книгу вызвало обсуждение задачи и под [этим](https://artofproblemsolving.com/community/c6h601134.) постом.
...
Вообще, в олимпиадной математике вам будет достаточно хорошего понимания дискретной теории вероятностей, а также поверхностное понимание общепринятой (вещественной) теории вероятностей. **Вещественный _теорвер_** (так математики называют теорию вероятностей) решает очень специфичный тип задач, который вы можете встретить только в подборках, в то время как **дискретный теорвер** может применяться как в задачах по комбинаторике, так и в задачах по теории чисел. Следует понимать, что дискретный теорвер не предусмотрен для использования в олимпиадах, и его изучение полностью факультативно. Оно бывает полезным в задачах по комбинаторике и может вывести нужный результат пропуская рассуждения вида подсчёта двумя способами (в пример можно взять задачу Example 2.1 из статьи Evan Chen’а [“Expected Uses of Probability”](https://cdn.bc-pf.org/resources/math/combinatorics/probabilistic_method/Evan_Chen-Expected_Uses_of_Probability.pdf).
...
В секции Algebra в [2] нужно быть знакомым с такими понятиями как *Распределения случайной величины $X$, Плотность распределения случайной величины $X$, Функция распределения, Математическое ожидание абсолютно непрерывной случайной величины $X$* (мы готовим из вас статистика!). Пусть эти понятия и звучат сложными, но на деле они интуитивно понятны, особенно при понимании поведения интегралов функций. Их можно будет скоро изучить в An Infinitely Large Napkin от Evan Chen-а (когда выйдет обновление на книгу).
...
1. [Expected Uses of Probability by Evan Chen](https://cdn.bc-pf.org/resources/math/combinatorics/probabilistic_method/Evan_Chen-Expected_Uses_of_Probability.pdf)
2. [Unexpected Uses of Probability by Ravi Boppana](https://cdn.bc-pf.org/resources/math/combinatorics/probabilistic_method/Ravi_Boppana-Unexpected_uses_of_probability.pdf)
3. Chapter 9: Probabilistic Method — [Olympiad Combinatorics by Pranav Sriram](https://cdn.bc-pf.org/resources/math/combinatorics/Pranav_Sriram-Olympiad_Combinatorics.pdf)
4. [The Probabilistic Method by Noga Alon and Joel H. Spencer](https://cdn.bc-pf.org/resources/math/combinatorics/probabilistic_method/Noga_Alon_Joel_Spencer-The_probabilistic_method.pdf)
