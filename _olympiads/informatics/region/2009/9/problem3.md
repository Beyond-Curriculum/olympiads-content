...
Первая строка входного файла содержит два целых числа: $N$ и $M$ ($1 <= N, M <= 1000$). Вторая строка содержит $N$ целых чисел: i-е число в строке – это $A_i$. Третья строка содержит $M$ целых чисел: j-е число в строке – это $B_j$. ($1 <= A_i, B_j <= 1000$). Числа в строках разделены пробелами.
