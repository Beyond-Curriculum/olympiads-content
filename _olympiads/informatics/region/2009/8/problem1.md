...
На первой строке входного файла расположены два целых числа: $N$ и $K$ ($1 <= N <= 10^9$, $1 <= K <= 100$). На следующих K строках расположены по 4 целых числа: $A_1$, $B_1$, $A_2$, $B_2$ – номера концов первой хорды ($A_1$, $B_1$) и второй хорды ($A_2$, $B_2$). Числа в строках разделены пробелами.
